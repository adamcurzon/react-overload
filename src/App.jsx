...
function App() {
    ...
    const DEFUALT_REPMAX = 60;
    const DEFAULT_INCREMENT = 5;

    const [repMax, setRepMax] = useState(60);
    ...
    function handleRepMaxChange(e) {
        ...
        localStorage.setItem("repMax", e.target.value);
    }

    function handleIncrementChange(e) {
        setIncrement(e.target.value);
        localStorage.setItem("increment", e.target.value);
    }


    useEffect(() => {
        setRepMax(localStorage.getItem("repMax") ?? DEFUALT_REPMAX);
        setIncrement(localStorage.getItem("increment") ?? DEFAULT_INCREMENT);
        updatePlan();
    }, []);
